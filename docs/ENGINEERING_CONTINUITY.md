...
## Ecosystem position
 Production-oriented AI API platform

## Current mission
Application/API layer: exposes production-oriented AI capabilities through a service boundary with health checks, configuration and integration contracts.
